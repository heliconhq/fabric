...
import { TextBlock, ValueMarker } from '@heliconhq/core';
import Example from '../docsComponents/Example/Example';

export default () => (
  <>
    <TextBlock>
      A <code>ValueMarker</code> component that can be used to highlight
    ...
    <Example<typeof ValueMarker>
      overrideControls={{ value: 'number' }}
